...
export default function UploadPage() {
    ...
    return (
        <>
            ...
            >
                <Typography variant="h2" color="#3c82af" align="center" mt={4} mb={2} fontWeight={600}>
                    VisuaLize your Learning
                </Typography>

                <Typography variant="h5" color="text.secondary" align="center" mb={4} px={2}>
